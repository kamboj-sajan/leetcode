...
- Divide `nums[0] = 5` twice: `5 &rarr; 2 &rarr; 1`, costing 2 operations.
- Divide `nums[1] = 6` once: `6 &rarr; 3`, costing 1 operation.
...
- Divide `nums[0] = 10` once: `10 &rarr; 5`, costing 1 operation.
- Multiply `nums[1] = 2` twice: `2 &rarr; 4 &rarr; 8`, costing 2 operations.
